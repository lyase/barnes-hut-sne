...
bool TSNE::load_data(const char * filename,double** data, int* n, int* d, double* theta, double* perplexity)
{
...
void TSNE::save_data(const char * filename ,double* data, int* landmarks, double* costs, int n, int d)
{
    ...
    *theta=2;
    double * perplexity;
    *perplexity=7;
    fwrite(theta, sizeof(double), 1, h);
    fwrite(perplexity, sizeof(double), 1, h);
